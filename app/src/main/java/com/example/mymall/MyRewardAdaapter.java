...
public class MyRewardAdaapter extends RecyclerView.Adapter<MyRewardAdaapter.Viewholder> {

    private List<RewardModel> rewardModelList;
    private Boolean useMiniLayout = false;

    public MyRewardAdaapter(List<RewardModel> rewardModelList, Boolean useMiniLayout) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view;
        if (useMiniLayout) {
             view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mini_rewards_layout, viewGroup, false);
        } else{
